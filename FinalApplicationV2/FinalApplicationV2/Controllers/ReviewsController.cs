...
namespace FinalApplicationV2.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,DateCreated,Content")] Reviews reviews)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,DateCreated,Content")] Reviews reviews)
        {
            if (ModelState.IsValid)
            {
